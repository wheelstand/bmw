from ..models import Models, Trim, ModelsShown, FeaturesAccessory, \
	Exterior, Upholstery, Wheel, Package, Option, Location, TrimEnImage, TrimFrImage, Gallery, Interior, Performance, \
	Colour, Information, TestDrive, KeepingInTouch, StaticModel, StandAloneOption, OptionalEquipment
...
from serializers import ModelsSerializer, TrimSerializer, ModelsShownSerializer, \
	...
	TrimEnImageSerializer, TrimFrImageSerializer, GallerySerializer, GalleryImageSerializer, InteriorSerializer, \
	PerformanceSerializer, ColourSerializer, UpholsterySerializer, InformationSerializer, TestDriveSerializer, \
	KeepingInTouchSerializer, TrimImageSerializer, StaticModelSerializer, StaticModelImageSerializer, \
	StaticModelImageFRSerializer, StandAloneOptionSerializer, ModelsShownFRImageSerializer, OptionalEquipmentSerializer
...
'''
class StaticModelENViewSet(viewsets.ModelViewSet):
    queryset = StaticModelEN.objects.all()
    serializer_class = StaticModelENSerializer
'''
